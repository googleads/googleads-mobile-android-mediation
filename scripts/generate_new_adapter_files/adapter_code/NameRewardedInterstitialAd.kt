...
/**
 * Used to load ##adapter_name## rewarded interstitial ads and mediate callbacks between Google Mobile Ads SDK and ##adapter_name## SDK.
 */
class ##adapter_name##RewardedInterstitialAd
private constructor(
  ...
  companion object {
    fun newInstance(
      ...
      mediationAdLoadCallback:
        MediationAdLoadCallback<MediationRewardedAd, MediationRewardedAdCallback>,
    ): Result<##adapter_name##RewardedInterstitialAd> {
      ...
      return Result.success(
        ##adapter_name##RewardedInterstitialAd(
          context,
          mediationAdLoadCallback,
        )
      )
