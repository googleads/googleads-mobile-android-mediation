...
/**
 * Used to load ##adapter_name## rewarded ads and mediate callbacks between Google Mobile Ads SDK and ##adapter_name## SDK.
 */
class ##adapter_name##RewardedAd 
private constructor(
  ...
  companion object {
    fun newInstance(
      ...
      mediationAdLoadCallback:
        MediationAdLoadCallback<MediationRewardedAd, MediationRewardedAdCallback>,
    ): Result<##adapter_name##RewardedAd> {
