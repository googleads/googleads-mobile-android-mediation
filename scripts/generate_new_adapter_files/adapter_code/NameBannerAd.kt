...
/**
 * Used to load ##adapter_name## banner ads and mediate callbacks between Google Mobile Ads SDK and ##adapter_name## SDK.
 */
class ##adapter_name##BannerAd
private constructor(
  ...
  companion object {
    fun newInstance(
      ...
      return Result.success(
        ##adapter_name##BannerAd(context, mediationAdLoadCallback, adSize)
      )
    }
  }
}
