...
public class SampleAdapter extends Adapter
   ...
   * MediationInterstitialListener, Bundle, MediationAdRequest, Bundle)} and {@link
   * #requestNativeAd(Context, MediationNativeListener, Bundle, NativeMediationAdRequest, Bundle)}
   * populated with the expected key/value pair(s) from the server. These value(s) should be used to
   * make an ad request.
   */
