...
class NativeAdLoader {
    ...
    /**
     * Indicates whether Nend has attempted to download their ad image bitmap. This is {@code true}
     * if Nend does not have an ad image to download.
     */
    ...
    /**
     * Indicates whether Nend has attempted to download their logo image bitmap. This is {@code
     * true} if Nend does not have a logo image to download.
     */
