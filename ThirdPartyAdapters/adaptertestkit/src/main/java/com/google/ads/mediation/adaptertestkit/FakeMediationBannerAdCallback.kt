...
/**
 * Fake implementation of [MediationBannerAdCallback] that records invocations of banner ad events.
 */
open class FakeMediationBannerAdCallback : FakeMediationAdCallback(), MediationBannerAdCallback {
