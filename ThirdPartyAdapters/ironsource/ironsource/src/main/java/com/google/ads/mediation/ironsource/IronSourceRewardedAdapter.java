...
/**
 * A {@link MediationRewardedVideoAdAdapter} to load and show IronSource rewarded video ads.
 */
public class IronSourceRewardedAdapter extends IronSourceBaseAdapter implements
        MediationRewardedVideoAdAdapter, ISDemandOnlyRewardedVideoListener {
    ...
    public void initialize(Context context,
        ...
        try {
            ...
            onLog("Server params for RV | appKey: " + appKey + " | isTestEnabled: "
    ...
    public void showVideo() {
        ...
        if (IronSource.isISDemandOnlyRewardedVideoAvailable(this.mInstanceID)) {
            ...
            // response to a loadAd request. If for any reason the adapter is not ready to show an
            // ad after sending an ad loaded callback, log a warning.
    ...
    //region IronSource RewardedVideoListener implementation.
    @Override
    public void onRewardedVideoAvailabilityChanged(String instanceId, final boolean available) {
        ...
        if (mMediationRewardedVideoAdListener != null) {
            sendEventOnUIThread(new Runnable() {
                public void run() {
                    if (available) {
                        mMediationRewardedVideoAdListener.onAdLoaded(
                                IronSourceRewardedAdapter.this);
                    } else {
        ...
        if (mMediationRewardedVideoAdListener != null) {
            sendEventOnUIThread(new Runnable() {
                public void run() {
                    ...
                    mMediationRewardedVideoAdListener.onVideoStarted(
                            IronSourceRewardedAdapter.this);
                }
            });
        }
    ...
    public void onRewardedVideoAdRewarded(String instanceId, final Placement placement) {
        ...
        onLog("onRewardedVideoAdRewarded for instance: " + instanceId + "rewarded: "
