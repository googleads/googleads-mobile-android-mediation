...
/**
 * Used to load DTExchange RTB banner ads and mediate callbacks between Google Mobile Ads SDK and
 * DTExchange SDK.
 */
class DTExchangeRtbBannerAd(
  ...
  companion object {
    private val TAG = DTExchangeRtbBannerAd::class.simpleName
  }
}
