...
/**
 * Used to load DTExchange RTB interstitial ads and mediate callbacks between Google Mobile Ads SDK
 * and DTExchange SDK.
 */
class DTExchangeRtbInterstitialAd(
  ...
  companion object {
    private val TAG = DTExchangeRtbInterstitialAd::class.simpleName
  }
}
