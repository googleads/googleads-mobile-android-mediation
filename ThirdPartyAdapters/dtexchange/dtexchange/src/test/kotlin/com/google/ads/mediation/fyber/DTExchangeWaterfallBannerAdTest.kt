...
class DTExchangeWaterfallBannerAdTest {
  ...
  private val bannerSpot = mock<InneractiveAdSpot>()
  ...
  fun setUp() {
    ...
    whenever(FyberFactory.createRewardedAdSpot()) doReturn bannerSpot
  }
  ...
  @Test
  fun onInneractiveSuccessfulAdRequest_ifLoadedSizeIsNotCloseToRequestedSize_invokesFailure() {
    mockStatic(InneractiveAdSpotManager::class.java).use {
      val mockAdViewController = mock<InneractiveAdViewUnitController>()
      val mockAdSpot =
        mock<InneractiveAdSpot> { on { selectedUnitController } doReturn mockAdViewController }
  ...
  fun onInneractiveFailedAdRequest_invokesOnFailure() {
    ...
    dtExchangeWaterfallBannerAd.onInneractiveFailedAdRequest(mockAdSpot, iErrorCode)
