...
public class PangleBannerAd implements MediationBannerAd, PAGBannerAdInteractionListener {
        ...
        new Listener() {
          ...
          public void onInitializeSuccess() {
            ...
            PAGBannerRequest request =
                pangleFactory.createPagBannerRequest(bannerSize);
  ...
  private PAGBannerSize getBannerSizeFromGoogleAdSize(Context context, AdSize adSize) {
    if (adSize != null) {
      ...
      } else if (adSize.getWidth() == PAGBannerSize.BANNER_W_300_H_250.getWidth() && adSize.getHeight() == PAGBannerSize.BANNER_W_300_H_250.getHeight()) {
        return PAGBannerSize.BANNER_W_300_H_250;
      } else if (adSize.getWidth() == PAGBannerSize.BANNER_W_728_H_90.getWidth() && adSize.getHeight() == PAGBannerSize.BANNER_W_728_H_90.getHeight()) {
        return PAGBannerSize.BANNER_W_728_H_90;
      } else {
        PAGBannerSize pagAnchoredSize = PAGBannerSize.getCurrentOrientationAnchoredAdaptiveBannerAdSize(context, adSize.getWidth());
