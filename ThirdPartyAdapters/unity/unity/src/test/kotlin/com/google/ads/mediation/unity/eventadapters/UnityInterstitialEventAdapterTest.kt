...
/** Unit tests for [UnityInterstitialEventAdapter]. */
@RunWith(AndroidJUnit4::class)
class UnityInterstitialEventAdapterTest {

  private val listener: MediationInterstitialListener = mock()
  private val adapter: MediationInterstitialAdapter = mock()

  private lateinit var eventAdapter: UnityInterstitialEventAdapter

  @Before
  fun setUp() {
    eventAdapter = UnityInterstitialEventAdapter(listener, adapter)
  }
