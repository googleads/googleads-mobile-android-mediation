...
class MintegralInterstitialAdTest {
  ...
  fun setUp() {
    mintegralInterstitialAd =
      MintegralWaterfallInterstitialAd(adConfiguration, interstitialAdLoadCallback, flagValueGetter)
  }
  ...
  fun onResourceLoadSuccess_invokesOnSuccess() {
    ...
    assertThat(interstitialAdLoadCallback).hasSucceededWith(mintegralInterstitialAd)
  }
