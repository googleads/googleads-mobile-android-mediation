...
public class ErrorMapper {
    ...
    /**
     * Create AdMob's error instance from (this) adapter's error instance.
     * Do **NOT** pass the Zucks Ad Network SDK's integer-based error code (e.g. convertSdkErrorCode result).
     */
    @NonNull
