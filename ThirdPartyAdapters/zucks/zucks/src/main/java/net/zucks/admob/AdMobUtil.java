...
public final class AdMobUtil {
    ...
    public static VersionInfo getNetworkSdkVersionInfo() {
        return new VersionInfo(
                Integer.parseInt(
                        com.google.ads.mediation.zucks.BuildConfig.ADAPTER_VERSION_MAJOR),
                Integer.parseInt(
                        com.google.ads.mediation.zucks.BuildConfig.ADAPTER_VERSION_MINOR),
                Integer.parseInt(
                        com.google.ads.mediation.zucks.BuildConfig.ADAPTER_VERSION_SDK_PATCH));
    }
     ...
     *
     * `VersionInfo` does not support the 4-segment versioning.
     * This method will be joining sdk and adapter's patch segment.
     */
    @NonNull
    public static VersionInfo getAdapterVersionInfo() {
        ...
        int adapterPatch =
                Integer.parseInt(
                        com.google.ads.mediation.zucks.BuildConfig.ADAPTER_VERSION_ADAPTER_PATCH);
