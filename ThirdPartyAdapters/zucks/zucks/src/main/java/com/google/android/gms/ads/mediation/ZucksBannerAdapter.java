...
/**
 * Banner Ad Adapter implementation for calls from ZucksAdapter.
 * Can **NOT** use this as a standalone adapter implementation.
 *
...
class ZucksBannerAdapter extends BaseMediationAdapter
    ...
    /**
     * For internal assertion.
     * Validate passed size and actual size are equals.
     */
    @VisibleForTesting
    @Nullable
