...
class PubMaticMediationAdapter(
  ...
  override fun collectSignals(signalData: RtbSignalData, callback: SignalCallbacks) {
    ...
    val pubMaticAdFormat = getPubMaticFormatFromGmaFormat(gmaAdFormat)
  ...
  companion object {
     ...
     */
    fun getPubMaticFormatFromGmaFormat(gmaFormat: AdFormat): POBAdFormat? =
      when (gmaFormat) {
        AdFormat.BANNER -> POBAdFormat.BANNER_AND_MREC
