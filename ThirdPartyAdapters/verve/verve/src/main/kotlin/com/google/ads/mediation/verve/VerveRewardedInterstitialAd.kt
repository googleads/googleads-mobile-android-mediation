...
/**
 * Used to load Verve rewarded interstitial ads and mediate callbacks between Google Mobile Ads SDK
 * and Verve SDK.
 */
class VerveRewardedInterstitialAd
private constructor(
  ...
  companion object {
    fun newInstance(
      ...
      mediationAdLoadCallback:
        MediationAdLoadCallback<MediationRewardedAd, MediationRewardedAdCallback>,
    ): Result<VerveRewardedInterstitialAd> {
      ...
      return Result.success(VerveRewardedInterstitialAd(context, mediationAdLoadCallback))
    }
  }
}
