...
/**
 * Used to load Bigo rewarded interstitial ads and mediate callbacks between Google Mobile Ads SDK
 * and Bigo SDK.
 */
class BigoRewardedInterstitialAd
private constructor(
  ...
  companion object {
    fun newInstance(
      ...
      mediationAdLoadCallback:
        MediationAdLoadCallback<MediationRewardedAd, MediationRewardedAdCallback>,
    ): Result<BigoRewardedInterstitialAd> {
      ...
      return Result.success(BigoRewardedInterstitialAd(context, mediationAdLoadCallback))
    }
  }
}
