    ...
    object : SdkFactory {
      ...
      override fun createNativeAdLoader(): BigoNativeAdLoaderWrapper =
        object : BigoNativeAdLoaderWrapper {
          ...
          override fun initializeAdLoader(loadListener: AdLoadListener<NativeAd>) {
            instance = NativeAdLoader.Builder().withAdLoadListener(loadListener).build()
          }
...
interface BigoNativeAdLoaderWrapper {
  fun initializeAdLoader(loadListener: AdLoadListener<NativeAd>)
