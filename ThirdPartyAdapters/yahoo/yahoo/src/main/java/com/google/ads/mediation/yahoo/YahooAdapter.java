...
public class YahooAdapter extends Adapter
  ...
  @Override
  public void requestBannerAd(@NonNull final Context context, @NonNull final MediationBannerListener listener,
                              @NonNull final Bundle serverParameters, @NonNull com.google.android.gms.ads.AdSize adSize,
                              @NonNull final MediationAdRequest mediationAdRequest, final Bundle mediationExtras) {
  ...
  @Override
  public void loadRewardedAd(@NonNull final MediationRewardedAdConfiguration mediationRewardedAdConfiguration,
                             @NonNull final MediationAdLoadCallback<MediationRewardedAd,
                                     MediationRewardedAdCallback> mediationAdLoadCallback) {
    yahooRewardedRenderer = new YahooRewardedRenderer(mediationAdLoadCallback, mediationRewardedAdConfiguration);
    yahooRewardedRenderer.render();
  }

  @Override
  public void requestNativeAd(@NonNull final Context context, @NonNull final MediationNativeListener listener,
                              @NonNull final Bundle serverParameters, @NonNull final NativeMediationAdRequest mediationAdRequest,
