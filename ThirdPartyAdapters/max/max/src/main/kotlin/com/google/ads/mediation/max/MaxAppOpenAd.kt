...
/**
 * Used to load Max app open ads and mediate callbacks between Google Mobile Ads SDK and Max SDK.
 */
class MaxAppOpenAd
private constructor(
  ...
  companion object {
    fun newInstance(
      ...
      return Result.success(MaxAppOpenAd(context, mediationAdLoadCallback))
    }
  }
}
