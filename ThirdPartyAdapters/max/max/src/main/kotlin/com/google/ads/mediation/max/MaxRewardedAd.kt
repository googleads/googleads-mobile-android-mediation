...
/**
 * Used to load Max rewarded ads and mediate callbacks between Google Mobile Ads SDK and Max SDK.
 */
class MaxRewardedAd
private constructor(
  ...
  companion object {
    fun newInstance(
      ...
      return Result.success(MaxRewardedAd(context, mediationAdLoadCallback))
    }
  }
}
