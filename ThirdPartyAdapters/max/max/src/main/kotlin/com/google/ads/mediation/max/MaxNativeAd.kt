...
/** Used to load Max native ads and mediate callbacks between Google Mobile Ads SDK and Max SDK. */
class MaxNativeAd
private constructor(
  ...
  companion object {
    fun newInstance(
      ...
      return Result.success(MaxNativeAd(context, mediationNativeAdLoadCallback))
    }
  }
}
