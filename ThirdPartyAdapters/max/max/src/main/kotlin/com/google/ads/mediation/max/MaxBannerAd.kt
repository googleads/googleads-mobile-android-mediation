...
/** Used to load Max banner ads and mediate callbacks between Google Mobile Ads SDK and Max SDK. */
class MaxBannerAd
private constructor(
  ...
  companion object {
    fun newInstance(
      ...
      return Result.success(MaxBannerAd(context, mediationAdLoadCallback, adSize))
    }
  }
}
