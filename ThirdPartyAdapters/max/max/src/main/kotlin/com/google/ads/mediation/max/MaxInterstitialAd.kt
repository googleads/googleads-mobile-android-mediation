...
/**
 * Used to load Max interstitial ads and mediate callbacks between Google Mobile Ads SDK and Max
 * SDK.
 */
...
private constructor(
  ...
  companion object {
    fun newInstance(
      ...
      return Result.success(MaxInterstitialAd(context, mediationAdLoadCallback))
    }
  }
}
