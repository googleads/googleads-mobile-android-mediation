...
- Verified compatibility with myTarget SDK version 5.47.1.
...
#### Version 5.27.3.0
- Verified compatibility with myTarget SDK version 5.27.3.

Built and tested with:
- Google Mobile Ads SDK version 24.6.0.
- MyTarget SDK version 5.27.3.
