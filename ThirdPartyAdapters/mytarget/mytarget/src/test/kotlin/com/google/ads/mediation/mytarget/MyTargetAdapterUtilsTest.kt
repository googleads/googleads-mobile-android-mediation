...
class MyTargetAdapterUtilsTest {
  ...
  @Test
  fun hasACConsent_withVersionTwoSpec_withEmptyConsentedPartners_withMyTargetDisclosed_returnsFalse() {
    sharedPreferences.stub {
      on { getInt(eq("IABTCF_gdprApplies"), any()) } doReturn 1
      on { getString(eq("IABTCF_AddtlConsent"), any()) } doReturn "2~~dv.1067.3"
    }
